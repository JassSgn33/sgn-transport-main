...
import {
  Phone, Mail, MapPin, Clock, Truck, Scale, ShieldCheck, Wrench,
  ChevronRight, Users, HardHat, Route, Instagram, FileText
} from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="#home" className="flex items-center gap-3">
              <img src="/sgn logo (1) (1).jpg.jpg" alt="SGN Logo"
            ...
            <nav className="hidden md:flex gap-6 text-sm">
              {NAV.map(n => (
                <a key={n.href} href={n.href} className="text-neutral-600 hover:text-neutral-900">
                  {n.label}
                </a>
              ))}
            </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="mt-6 flex flex-wrap gap-6 text-sm text-neutral-600">
              <span className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4"/> CVOR • WSIB • Insured
              </span>
              <span className="flex items-center gap-2">
                <Clock className="h-4 w-4"/> Mon–Sat 6:00am–7:00pm
              </span>
              <span className="flex items-center gap-2">
            ...
            <FadeIn delay={0.1}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <div className="w-full h-[500px] overflow-hidden rounded-3xl shadow-2xl">
  <img
    src="/hero-truck.jpeg"
    alt="SGN Truck"
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="backdrop-blur bg-white/80 rounded-2xl p-4 shadow">
                    <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                      ...
                      <a href="#order" className="inline-flex items-center gap-1 text-neutral-800 hover:underline">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Hourly or per-load, day or night. Professional drivers, clean equipment, clear communication.
            </p>
          </FadeIn>
          ...
          <FadeIn>
            <div className="flex items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-neutral-600">
                  Tri-axles ready for heavy duty work. Well-maintained with daily inspections.
                </p>
              </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="card-title flex items-center gap-2">
                      <HardHat className="h-5 w-5"/> {f.name}
                    </div>
                  </div>
      ...
      <section id="coverage" className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Peel • Halton • Durham • York • Toronto • Waterloo Region
            </p>
          </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <ul className="grid sm:grid-cols-2 gap-3 text-sm">
                {[
                  ...
                  "Asphalt & municipal paving",
                  "Topsoil & clean-fill moves",
                  "Day & night shifts",
                  "Ticketed disposal runs",
                  "Broker coordination"
                ].map(item => (
      ...
      <section id="compliance" className="py-16 lg:py-24 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Professional, insured, and documentation-ready for site onboarding.
            </p>
          </FadeIn>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="card">
              <div className="card-header">
                <div className="card-title flex items-center gap-2">
                  <FileText className="h-5 w-5"/> CVOR & Insurance
                </div>
              </div>
              <div className="card-content">
                Active CVOR, liability and cargo insurance. Certificates provided upon request.
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-header">
                <div className="card-title flex items-center gap-2">
                  <ShieldCheck className="h-5 w-5"/> WSIB & Training
                </div>
              </div>
              <div className="card-content">
                WSIB clearance, daily circle checks, and safety-first procedures.
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-header">
                <div className="card-title flex items-center gap-2">
                  <Users className="h-5 w-5"/> Experienced Drivers
                </div>
              </div>
              <div className="card-content">
                Reliable, punctual operators with subdivision and municipal experience.
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="drivers" className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Apply to drive tri-axle dump trucks with reliable, year-round work.
            </p>
          </FadeIn>
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-8">
            ...
            <div className="card lg:col-span-2">
              <div className="card-content p-6">
                <form action="https://formspree.io/f/your-id-here" method="POST"
                  ...
                  <input name="license" placeholder="License class (AZ/DZ)" className="input" required />
                  <input name="experience" placeholder="Years of experience" className="input" />
                  <input name="availability" placeholder="Availability" className="input" />
                  <textarea name="notes" placeholder="Tell us about experience…" className="textarea sm:col-span-2 min-h-[120px]" />
            ...
            <div className="card">
              <div className="card-header">
                <div className="card-title">Driver Requirements</div>
              </div>
              <div className="card-content space-y-2">
                <div>• Clean abstract & CVOR preferred</div>
                <div>• Experience on subdivision & municipal sites</div>
                <div>• Safety-first attitude; daily inspections</div>
                <div>• Punctual communication</div>
              </div>
            </div>
          </div>
      ...
      <section id="brokers" className="py-16 lg:py-24 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Have extra trucks? Partner with SGN for steady work across the GTA.
            </p>
          </FadeIn>
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-8">
            ...
            <div className="card lg:col-span-2">
              <div className="card-content p-6">
                <form action="https://formspree.io/f/your-id-here" method="POST"
                  ...
                  <input name="phone" placeholder="Phone" className="input" required />
                  <input name="email" type="email" placeholder="Email" className="input" required />
                  <input name="fleet" placeholder="Truck types & count" className="input sm:col-span-2" />
                  <input name="coverage" placeholder="Regions covered" className="input sm:col-span-2" />
                  <textarea name="compliance" placeholder="WSIB / Insurance Notes…" className="textarea sm:col-span-2 min-h-[120px]" />

                  <div className="sm:col-span-2 flex items-center gap-3">
                    <button type="submit" className="btn btn-primary">Apply to Partner</button>
                    <div className="text-xs text-neutral-500">
                      We’ll review and follow up quickly.
                    </div>
                  </div>
            ...
            <div className="card">
              <div className="card-header">
                <div className="card-title">What We Look For</div>
              </div>
              <div className="card-content space-y-2">
      ...
      <section id="order" className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="flex items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-neutral-600">
                  Tell us your scope and schedule—day or night—and we’ll stage trucks on time.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-8">
            ...
            <div className="card lg:col-span-2">
              <div className="card-content p-6">
                <form action="https://formspree.io/f/your-id-here" method="POST"
                  ...
                  <input name="trucks" placeholder="# of trucks needed" className="input" />
                  <input name="material" placeholder="Material (asphalt, topsoil, clean-fill…)" className="input sm:col-span-2" />
                  <input name="disposal" placeholder="Disposal site" className="input sm:col-span-2" />
                  <input name="po" placeholder="PO/Reference" className="input" />
                  <textarea name="details" placeholder="Loads/hour, staging notes…" className="textarea sm:col-span-2 min-h-[120px]" />

                  <div className="sm:col-span-2 flex items-center gap-3">
                    <button type="submit" className="btn btn-primary">Submit Order Request</button>
                    <div className="text-xs text-neutral-500">
                      Or call <a href={`tel:${BUSINESS.phone}`} className="underline">
                        {BUSINESS.phone}
                      </a>
                    </div>
                  </div>
            ...
            <div className="card">
              <div className="card-header">
                <div className="card-title">Fast Scheduling</div>
              </div>
              <div className="card-content space-y-2">
      ...
      <section id="contact" className="py-16 lg:py-24 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-2 text-neutral-600">
              Call, email, or send a request—we’ll respond fast.
            </p>
          </FadeIn>
            ...
            <div className="card">
              <div className="card-content space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href={BUSINESS.social.instagram} target="_blank"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="text-sm text-neutral-600 mt-1">
                Serving contractors across the GTA with punctual, professional dump-truck hauling.
              </div>
            </div>
